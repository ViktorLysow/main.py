...
endBoss = Boss() # hier den korrekten Aufruf ergänzen (zusätzliche Parameter in Klammern)
...
def Level2(spieler):
    ...
    if prinzessin.mlaufen(spieler, endBoss):                                      #mit mlaufen läuft die Prinzessin und es wird überprüft ob die Prinzessin getötet wurde
