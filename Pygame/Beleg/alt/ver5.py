...
pygame.display.set_caption("ver5")

westAussenWand = pygame.draw.Rect(0,0,48,624)
ostAussenWand = pygame.draw.Rect(816,0,-48,624)
nordAussenWand = pygame.draw.Rect(0,0,816,48)
suedAussenWand = pygame.draw.Rect(0,624,816,-48)
...
class Figur:
    ...
    def laufen(self, richtung):
        ...
        self.rechteck = pygame.Rect(self.x + 18, self.y + 18, self.breite, self.hoehe)
...
spieler1 = Held(576,480,2,48,48,"Held")
