...
siegBild = pygame.image.load("Grafik/sieg.png")
verlorenBild = pygame.image.load("Grafik/verloren.png")

angriffLinks = pygame.image.load("Grafik/angriffLinks.png")

test = "Grafik"

rechtsGehen = [pygame.image.load(f"{test}/rechts1.png"), pygame.image.load("Grafik/rechts2.png"),
...
siegSound = pygame.mixer.Sound("sound/robosieg.wav")
verlorenSound = pygame.mixer.Sound("sound/robotod.wav")
...
def Kollison():
    ...
    zombieRechteck = pygame.Rect(zombie1.x + 18, zombie1.y+24, zombie1.breite -36, zombie1.hohe -24)
...
while go:
    ...
    if gedrueckt[pygame.K_SPACE] and len(kugeln) <= 0 and spieler1.ok:
